package com.marck.shoppingmall.adapter.warelist;
...
public class WareListAdapter extends RecyclerView.Adapter<WareListAdapter.ViewHolder> {
    ...
    public static final String TAG = com.marck.shoppingmall.adapter.hot.HotPagerAdapter.class.getSimpleName();
    ...
    public WareListAdapter(Context context, List<HotSale> data, int layoutResId){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        mView = mInflater.inflate(mLayoutResId, parent, false);
    ...
    public void resetLayout(int layoutResId){
        this.mLayoutResId = layoutResId;
